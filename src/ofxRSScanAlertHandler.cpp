...
void ofxRSScanAlertHandler::reset()
{
	...
	mStatusMotion = (FaceStatusMotion)0;
}
...
void PXCAPI ofxRSScanAlertHandler::OnAlert(const PXC3DScan::AlertData& data)
{
	...
	case PXC3DScan::ALERT_FACE_MOTION_IN_RANGE: { mStatusMotion = FaceStatusMotion_InRange; } break;
	case PXC3DScan::ALERT_FACE_MOTION_TOO_SLOW: { mStatusMotion = FaceStatusMotion_TooSlow; } break;
	case PXC3DScan::ALERT_FACE_MOTION_TOO_FAST: { mStatusMotion = FaceStatusMotion_TooFast; } break;
	}
}